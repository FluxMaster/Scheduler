...
namespace Scheduler
{
    public partial class ScheduleMaker : Form
    {
        ...
        public ScheduleMaker()
        {
            ...
            //add an event listener for all textboxes in the form when a key is pressed, calls the txtBox_KeyPress method,
            //which restricts input to only letters and numbers
        ...
        //restricts input to only letters and numbers
